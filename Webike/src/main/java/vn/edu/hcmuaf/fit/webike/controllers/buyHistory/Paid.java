...
//        LogService.log(levelInfo, "Xem lịch sử mua hàng", user.getId() + "", "", "Xem trang " + page);
        request.getRequestDispatcher("GKY/buyHistoryPaid.jsp").forward(request, response);
