...
@WebServlet(name = "PreparingHistory", value = "/preparing")
public class Preparing extends HttpServlet {
    private static final int ITEMS_PER_PAGE = 5;
    final String levelInfo = LogService.LEVEL_INFO;
    private static final String status = "Đang chuẩn bị hàng";
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("GKY/buyHistoryPreparing.jsp").forward(request, response);
