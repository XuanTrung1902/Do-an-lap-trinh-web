...
<div class="app">
    ...
    <div class="container-center">
        ...
        <div class="profile-form" id="profile-form">
            <form action="<%= request.getContextPath()%>/Profile" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="fullname" name="fullname" value="${sessionScope.auth.name}"
                           placeholder="Văn Chương">
                </div>

                <div class="form-group">
                    <label for="phone">Số điện thoại</label>
                    <input type="tel" id="phone" name="phone" value="${sessionScope.auth.phoneNum}"
                           placeholder="0312358497">
                </div>
                <div class="form-group">
                    <label for="address">Địa chỉ</label>
                    <input type="text" id="address" name="address" value="${sessionScope.auth.address}"
        ...
        <div class="change-password-form" id="change-password-form" style="display: none;">
            <form id="password-form" action="<%= request.getContextPath()%>/ChangePassword" method="post">
                <div class="form-group">
                    ...
                    <input type="password" id="current-password" name="current-password" placeholder="Nhập mật khẩu cũ"
                           value="<%= request.getAttribute("current-password") != null ? request.getAttribute("current-password") : "" %>"
                           required>
                </div>
        ...
        <div class="change-avatar-form" style="display:none;">
            ...
            <div class="form-group">
                <img id="avatar-preview" src="<%= request.getContextPath() %>/${sessionScope.auth.image}"
                     alt="Ảnh đại diện" class="avatar-preview header__navbar--user-img">
            </div>
            <form id="change-avatar-form" action="<%= request.getContextPath() %>/ChangeAvatar" method="post"
                    ...
                    <div class="col-md-5 offset-md-1 mb-3">
                        <form>
                            ...
                            <div class="d-flex flex-column flex-sm-row w-100 gap-2">
                                <img class="footer__banking"
                                     src="<%= request.getContextPath()%>/GKY/assets/img/bankcard1.png" alt="">
                                <img class="footer__banking"
                                     src="<%= request.getContextPath()%>/GKY/assets/img/bankcard2.png" alt="">
                                <img class="footer__banking"
                                     src="<%= request.getContextPath()%>/GKY/assets/img/bankcard3.png" alt="">
                                <img class="footer__banking"
                                     src="<%= request.getContextPath()%>/GKY/assets/img/bankcard4.png" alt="">
                                <img class="footer__banking"
                                     src="<%= request.getContextPath()%>/GKY/assets/img/bankcard5.png" alt="">
                                <img class="footer__banking"
                                     src="<%= request.getContextPath()%>/GKY/assets/img/bankcard6.png" alt="">
                            </div>
